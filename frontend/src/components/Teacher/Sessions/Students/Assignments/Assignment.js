...
function Assignment() {
  ...
  const deleteAssignment = async (id) => {
    await axios
      .delete(`http://localhost:5000/teacher/assignments/${id}`, {
        headers: {
          token: token,
        },
      })
      ...
      .then((res) => {
        navigate(
          `/teacher/sessions/students/${session}/${discipline}/assignments`
        );
      });
  };
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="row mb-4 ">
            ...
            <div className="col-8 col-lg-4 mt-2">{assignment.session}</div>

            <div className="col-4 col-lg-2">
              <h6 className="text-uppercase text-muted">Submission Date</h6>
            </div>
            <div className="col-8 col-lg-4 mt-2">
            ...
            <div className="col-8 col-lg-4 mt-2">{assignment.discipline}</div>
            ...
            <div className="col-8 col-lg-4 mt-2">{assignment.marks}</div>
          </div>
          ...
          <div>
            ...
            <Link
              to={`/teacher/sessions/students/${session}/${discipline}/assignments/edit/${assignment.id}`}
              style={{ color: "inherit", textDecoration: "inherit" }}
            >
              <Button
                variant="contained"
