...
function EditStudent() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      await axios.put(`http://localhost:5000/admin/students/update/`, fd, {
        headers: {
          token: token,
      ...
      <form onSubmit={handleSubmit} className="needs-validation">
        ...
        <div className="row">
          <div className="form-lgroup col-md-3">
            ...
            <input
              name="rollnumber"
              className={`form-control input ${errors.rollnumber ? "is-invalid" : ""}`}
              type="text"
              id="rollnumber"
          ...
          <div className="form-group col-md-3">
            ...
            <input
              name="cgpa"
              className={`form-control input ${errors.cgpa ? "is-invalid" : ""}`}
              type="text"
              id="cgpa"
              placeholder="CGPA"
              onChange={handleChange}
          ...
          <div className="form-group col-md-3">
            ...
            <select
              id="discipline"
              name="discipline"
              className={`form-control input ${errors.discipline ? "is-invalid" : ""
                }`}
          ...
          <div className="form-group col-md-3">
            ...
            <select
              id="session"
              name="session"
              className={`form-control input ${errors.session ? "is-invalid" : ""
                }`}
