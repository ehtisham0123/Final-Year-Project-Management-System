...
function CreateProject() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (errors.name == "" && errors.details == "") {
      await axios
        .post("http://localhost:5000/admin/projects/create", formdata, {
          headers: {
            token: token,
          },
        })
        ...
        <form onSubmit={handleSubmit} className="needs-validation">
          ...
          <div className="row">
            ...
            <div className="form-group col-md-12">
             ...
             <div className="form-group col-md-12">
              <a href="https://smallseotools.com/plagiarism-checker-api/" target="_blank">
              <button
                className="input form-control btn btn-outline-danger"
              >
